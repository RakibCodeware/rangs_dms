...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div align="center">
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="lblTQtyCaption" runat="server" Text="Total Qty : "></asp:Label>
                    <asp:Label ID="lblTQty" runat="server" Text="0" Font-Bold="True"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <asp:Label ID="lblTAmntCaption" runat="server" Text="Total Amnt : "></asp:Label>
                    <asp:Label ID="lblTAmnt" runat="server" Text="0" Font-Bold="True"></asp:Label>
                </td>
            </tr>
            <tr>
                <td> &nbsp;</td>
