    ...
    <div align="center">
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td style="text-align: Left; font-family: Arial; " 
                    class="style35">
                    <asp:RadioButton ID="RadioButton3" runat="server" Text="Product Category Wise" 
                    GroupName="Sales" 
                    OnCheckedChanged="RadioButtonSales_CheckedChanged" 
                    AutoPostBack="true" />
                </td>
                ...
                <td style="text-align: left" class="style21">
                    <asp:DropDownList ID="ddlGroup"
                        ...
                        BackColor="#F6F1DB"
                        Height="28px" Width="250px" TabIndex="6"
                        Visible="False" 
            ...
            <tr>
                ...
                <td class="style20">&nbsp;</td>
                <td class="style21">
                    <asp:DropDownList ID="ddlEntity" runat="server" CssClass="form-control" 
                        Width="250px" onselectedindexchanged="ddlEntity_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left" class="style35">
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="View" OnClick="btnAdd_Click" 
                        Width="98px" CssClass="btn btn-primary"
                        Font-Size="Small"
