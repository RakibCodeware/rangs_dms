...
public partial class Default_Administrator : System.Web.UI.Page
{
    ...
    protected void fnLoadData_NewProduct()
    {
        ...
        sSql = "";
        sSql = "SELECT TOP (20) ProductID, Code, Model, ProdName, GroupName, UnitPrice, Discontinue";
    ...
    protected void btnSlowItemSearch_Click(object sender, ImageClickEventArgs e)
    {
        fnLoadData_SlowItems();
    }
    ...
    protected void fnLoadData_SlowItems()
    {
        ...
        sSql = "";
        /*
        sSql = "SELECT dbo.VW_Model_Stock.ProductID, dbo.VW_Model_Stock.Model, dbo.VW_Model_Stock.bQty,";
        sSql = sSql + " dbo.VW_Product_Last_Transaction.maxDate, dbo.VW_Model_Stock.GroupName, ";
        sSql = sSql + " dbo.VW_Model_Stock.ProdName";
        sSql = sSql + " FROM dbo.VW_Model_Stock INNER JOIN";
        sSql = sSql + " dbo.VW_Product_Last_Transaction ON";
        sSql = sSql + " dbo.VW_Model_Stock.ProductID = dbo.VW_Product_Last_Transaction.ProductID";
        sSql = sSql + " WHERE (dbo.VW_Model_Stock.bQty > 0)";

        if (txtDay.Text.Length > 0)
        {
            sSql = sSql + " AND dbo.VW_Product_Last_Transaction.maxDate<'" + tDate + "'";
        }

        sSql = sSql + " ORDER BY dbo.VW_Model_Stock.GroupName, dbo.VW_Model_Stock.Model";
        */
        //------------
