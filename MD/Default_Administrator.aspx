...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="panel panel-info">
                <div class="panel-heading">
                    CTP Wise Target & Achivement &nbsp;
                    <asp:Label ID="lblDateCTPWise" runat="server" Text="[Date]" Visible="False"></asp:Label>
                </div>
                <div class="panel-body" style="height: 400px; overflow: scroll">
                    ...
                    <p>
                        <asp:GridView ID="GridView5" runat="server"                        
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="eName" HeaderText="CTP Name" />                                               
                                <asp:BoundField DataField="tTarget" HeaderText="Target Amnt(Lac)" />
                                <asp:BoundField DataField="tAmnt" HeaderText="Sales Amnt" />                            
                                <asp:BoundField DataField="tReq" HeaderText="Required" />
    ...
    <!-- ********************************************************************************* -->
    <!-- SLOW/FAST ITEM SALES -->
    <div class="row" style="display :none">
        <div class="col-lg-12">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    Slow Items List
                    <asp:Label ID="lblSlowItemCaption" runat="server" Text="[Date]" Visible="False"></asp:Label>
                ...
                <div class="panel-body" style="height: 400px; overflow: scroll">
                    ...
                    <table width ="100%">
                        <tr>                                
                            <td>
                                No Transaction on &nbsp;
                                <asp:TextBox ID="txtDay" runat="server" Width="40px" TabIndex="1" 
                                    ToolTip="" MaxLength="10" Text="60" Style="text-align :center ">
                                </asp:TextBox> 
                                Days &nbsp;
                                <asp:ImageButton ID="btnSlowItemSearch" runat="server" Height="16px" 
                                    ImageUrl="~/Images/search.png" Width="16px" 
                                    data-toggle="tooltip" title="Click here for Search data ..." onclick="btnSlowItemSearch_Click"
                                /> 
                            </td>
                            <td></td>
                            <td></td>  
    ...
    <div class="row" style="display : none">
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="height: 100px; overflow: scroll">
                    <p>ICT Fair-2017 @Bangabandhu International Conference. 18-20 Oct 2017</p>
                </div>
                <div class="panel-footer">
                    <a href="#">Details</a>
                </div>
