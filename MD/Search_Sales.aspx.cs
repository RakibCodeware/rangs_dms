...
public partial class Search_Sales_info : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        sSql = sSql + " dbo.MRSRMaster.NetSalesAmnt, SUM(dbo.MRSRDetails.TotalAmnt) AS tAmnt,";
        sSql = sSql + " SUM(dbo.MRSRDetails.DiscountAmnt) AS tDis, SUM(dbo.MRSRDetails.NetAmnt) AS tNet,";
        sSql = sSql + " dbo.Customer.CustName, dbo.Customer.Mobile, dbo.MRSRMaster.POCode,";
        sSql = sSql + " dbo.Entity.eName, dbo.Customer.Email";
        ...
        sSql = sSql + " GROUP BY dbo.MRSRMaster.MRSRMID, dbo.MRSRMaster.MRSRCode, dbo.MRSRMaster.TDate, dbo.MRSRMaster.TrType,";
        sSql = sSql + " dbo.MRSRMaster.NetSalesAmnt, dbo.Customer.CustName,";
        sSql = sSql + " dbo.Customer.Mobile, dbo.MRSRMaster.POCode, dbo.Entity.eName, dbo.Customer.Email";

        sSql = sSql + " ORDER BY dbo.Entity.eName, dbo.MRSRMaster.TDate, dbo.MRSRMaster.MRSRCode";
        //sSql = sSql + " HAVING (dbo.MRSRMaster.TrType = 3) AND ";
        //sSql = sSql + " (dbo.MRSRMaster.TDate = CONVERT(DATETIME, '2020-05-09 00:00:00', 102))";
