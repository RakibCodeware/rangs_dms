...
public partial class Search_Installation : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        string sSql = "";
        sSql ="SELECT dbo.tbInstallationMaster.IAID, dbo.tbInstallationMaster.EID, dbo.Entity.eName,";
        sSql = sSql + " dbo.tbInstallationMaster.VAID, ";
        ...
        sSql = sSql + " dbo.Product ON dbo.tbInstallationDetails.ProductID = dbo.Product.ProductID ";
        //sSql = sSql + " INNER JOIN dbo.tbVendorInfo ON dbo.tbInstallationMaster.VAID = dbo.tbVendorInfo.VAID";

        sSql = sSql + " WHERE  (dbo.tbInstallationMaster.EID = '" + Session["EID"] + "') ";
        sSql = sSql + " AND (dbo.tbInstallationMaster.RefDate >= '" + Convert.ToDateTime(this.txtFrom.Text) + "'";
        sSql = sSql + " AND dbo.tbInstallationMaster.RefDate <= '" + Convert.ToDateTime(this.txtToDate.Text) + "')";
