        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td style="text-align: left" class="style21">
                    <asp:TextBox ID="txtCHNo" runat="server" Width="300px"  CssClass="form-control"
            ...
            <tr>
                <td colspan="8" align="center"
                    style="background-image:url(../Images/header.jpg); height:1.5px; font-family: Arial;">                        
                    </td>
            </tr>
            <tr>
                <td class="style26"></td>
            ...
            <tr>
                ...
                <td style="text-align: left" >  
                    <div class="side-by-side clearfix">                                  
                        <asp:DropDownList ID="ddlContinents" class="chzn-select"
                            ...
                            Width="300px" Height="32px" TabIndex="6"
                ...
                <td align="left" class="style33">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                <td align="left" class="style25">Product Code :
                    </td>
                <td align="left">
                    <asp:TextBox ID="txtCode" runat="server" AutoPostBack="True" Width="300px"
                        CssClass="form-control" ontextchanged="txtCode_TextChanged">
                    </asp:TextBox>
                </td>
                <td align="left"></td>
            ...
            <tr>
                ...
                <td class="style30"> : </td>
                <td style="text-align: left" class="style21" >
                    <asp:TextBox ID="txtQty" runat="server" Width="300px" 
                ...
                <td class="style32">
                    <asp:TextBox ID="txtProdDesc" runat="server" Width="300px" CssClass="form-control"
            ...
            <tr>
                ...
                <td style="text-align: left" class="style21" >
                    <asp:TextBox ID="txtRemarks" runat="server" Width="300px" 
                        style="font-weight: 700" TabIndex="5"></asp:TextBox>
                </td>
                <td class="style33">&nbsp;</td>
                <td align="left"></td>
                <td align="left"></td>
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                <td>&nbsp;
                    ...
                    <asp:Label ID="lblMailTo" runat="server" Visible="False"></asp:Label>
                </td>
            </tr>
        </table>
