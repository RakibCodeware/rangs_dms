...
public partial class Deposite_Entry : System.Web.UI.Page
{
    ...
    protected void fnLoadData()
    {
        ...
        sSql = sSql + " BranchName, DepositAmnt,IpdcAmnt, DepositType, DepositBy, POSMachine, DepositeSlip, AccApproved, Remarks";
    ...
    protected void btnSaveClick(object sender, EventArgs e)
    {
        ...
        //----------------------------------------------------------------------
        if (ddlDepositeType.SelectedItem.Text == "EMEI")
        {
            if (ddlTenor.SelectedItem.Text == "--select--")
            {
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Alert",
                            "<script>alert('" + "Select EMEI Tenor 3month/6month/9month/12month" + "');</script>", false);
                return;
            }
        }
        ...
        if (ddlDepositeType.SelectedItem.Text == "IPDC")
        {
            txtCardNo.Text = txtIpdcAcc.Text;
            ddlBankName.SelectedItem.Text = "IPDC";
            ddlTenor.SelectedItem.Text = ddlIpdcTenure.SelectedItem.Text;
            //txtIpdcAmnt = 
        }
        //SAVE DATA IN MASTER TABLE
        sSql = "";
        sSql = "INSERT INTO tbDeposit(RefNo,DepositDate,EID," +
               "BankID,BankName,BranchName,DepositAmnt,DepositType,DepositBy,Remarks," +
               "POSMachine,CardNo,ApprovalCode,UserID,EntryDate,EMEITenor,IpdcAmnt)" +
                     ...
                     " '" + ddlBankName1.SelectedItem.Text + "'," +
                     " '" + txtCardNo.Text + "', '" + txtAppCode.Text + "'," +
                     " '" + Session["UserID"] + "', '" + DateTime.Today + "', '" + ddlTenor.SelectedItem.Text + "'," +
                     " '" + txtIpdcAmnt.Text + "'" +
                     " )";
        SqlCommand cmd = new SqlCommand(sSql, conn);
        conn.Open();
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " DepositType, DepositBy, Remarks, POSMachine, CardNo, ApprovalCode,";
        sSql = sSql + " DepositeSlip, AccApproved, EntryDate, UserID, EID";
        ...
        if (dr.Read())
        {
            ...
            this.txtCardNo1.Text = dr["CardNo"].ToString();
            this.txtAppCode1.Text = dr["ApprovalCode"].ToString();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " CardNo='" + this.txtCardNo1.Text + "',";
        sSql = sSql + " ApprovalCode='" + this.txtAppCode1.Text + "',";
    ...
    protected void ddlDepositeType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Panel1.Visible = true;
            ddlTenor.Visible = false;
            tenorlbl.Visible = false;
            tenorlbl.Attributes["style"] = "display:none";
        }
        else if (ddlDepositeType.SelectedItem.Text == "EMEI")
        {
            Panel1.Visible = true;
            ddlTenor.Visible = true;
            tenorlbl.Visible = true;
            tenorlbl.Attributes["style"] = "";
        }
        else if (ddlDepositeType.SelectedItem.Text == "IPDC")
        {
            Panel2.Visible = true;
            Panel1.Visible = false;
            ddlTenor.Visible = false;
            tenorlbl.Visible = false;
            //ddlIpdcTenure.Visible = true;
            //tenorlbl.Visible = true;
            //tenorlbl.Attributes["style"] = "";
        }
        else
