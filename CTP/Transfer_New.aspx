...
CodeFile="Transfer_New.aspx.cs" Inherits="Forms_Transfer_New" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" 
        style="padding:5px; background-color: #008080;" align="center"> Product Transfer Entry ...</h2>
    <p>
    ...
    <div align="center">
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                <td class="style1"></td>
                <td class="style2" align="left">Transfer To</td>
                <td class="style3">:</td>
