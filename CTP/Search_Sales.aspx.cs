...
public partial class Search_Sales_info : System.Web.UI.Page
{
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        string sPID = Session["sBillNo"].ToString();
        string sSql = "";
        ...
        string cardType = "";
        sSql = " SELECT dbo.MRSRMaster.MRSRCode," +
        ...
        if (dr.Read())
        {
            cardType = dr["CardType1"].ToString();
    ...
    private void fnLoadData()
    {
        ...
        sSql = sSql + " Entity_1.eName AS DelFrom";

        sSql = sSql + " FROM   dbo.MRSRMaster INNER JOIN";
        sSql = sSql + " dbo.Entity ON dbo.MRSRMaster.OutSource = dbo.Entity.EID LEFT OUTER JOIN";
        sSql = sSql + " dbo.Customer ON dbo.MRSRMaster.Customer = dbo.Customer.Mobile LEFT OUTER JOIN";
    ...
    */
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        sSql = " SELECT dbo.MRSRMaster.MRSRMID, dbo.MRSRMaster.MRSRCode," +
            ...
            "CardNo1,CardNo2,CardType1,CardType2," +
            "Bank1,Bank2,SecurityCode,SecurityCode2," +
            "AppovalCode1,AppovalCode2,ProductGroup," +
            "Remarks,TermsCondition," +
            ...
            ",((SELECT SUM(dbo.MRSRDetails.NetAmnt) FROM dbo.Product INNER JOIN dbo.MRSRDetails ON dbo.Product.ProductID = dbo.MRSRDetails.ProductID" +
            " WHERE (dbo.MRSRDetails.MRSRMID = dbo.MRSRMaster.MRSRMID)) - dbo.MRSRMaster.NetSalesAmnt) AS RedeemAmt" +
            " FROM dbo.MRSRMaster LEFT OUTER JOIN" +
            " dbo.Customer ON dbo.MRSRMaster.Customer = dbo.Customer.Mobile" +
            " WHERE (dbo.MRSRMaster.MRSRCode = '" + sPID + "')" +
            " AND (dbo.MRSRMaster.TrType = 3)";
        ...
        if (dr.Read())
        {
            ...
            this.lblRedeemAmnt.Text = dr["RedeemAmt"].ToString();
