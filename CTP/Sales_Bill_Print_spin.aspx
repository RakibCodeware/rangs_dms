...
AutoEventWireup="true" CodeFile="Sales_Bill_Print_spin.aspx.cs" Inherits="Sales_Bill_Print_spin" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" style="padding:5px"> Print Customer Bill / Money Receipt ...</h2>
    ...
    <div>
        <asp:Button CssClass="btn btn-primary" ID="btnCancel" runat="server" 
            Height="35px" Text="Done"  
            Font-Size="Small"
            Width="120px" TabIndex="9" onclick="btnCancel_Click" />                    
    </div>
    <div>&nbsp;</div>
