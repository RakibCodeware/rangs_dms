...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <div class="col-sm-12 bg-white" style="padding:5px; font-family: Tahoma;" align="center">
            <h3 style="color:red">
                <asp:Label ID="passexp" runat="server" Text="0">your password expiraion date is 15/12/2022 ..for security purpose Please change your password(keep remember that pass) by yourself before the deadline..<br /><br /><a class="btn btn-danger" href="ChangePassword.aspx">Change Password Link</a></asp:Label>
            </h3>
        </div>
        <div>&nbsp;</div>
