...
public partial class Forms_ChangePassword : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        sSql = "";
        sSql = "UPDATE SoftUser SET " +
       " Passward='" + this.txtConfirmPass.Text + "'" +
       " ,OldPassword='" + this.txtOldPass.Text + "'" +
       " ,PassChangedDate='" + DateTime.Now.ToString() + "'" +
       " ,PassExpDate='" + DateTime.Now.AddDays(7).ToString() + "'" +
            " WHERE UserName='" + Session["UserName"] + "'";
        SqlCommand cmd = new SqlCommand(sSql, conn);
        conn.Open();
        cmd.ExecuteNonQuery();
