...
CodeFile="Requirement_List_Details.aspx.cs" Inherits="CTP_Requirement_List_Details" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h4 class="col-sm-12 bg-primary" style="padding:5px"> Requirement List ...</h4>
    ...
    <h1>
        ...
        <asp:Label ID="Label4" runat="server" Text="Requirement # " ForeColor="Red" 
   ...
   <a href="Requirement_List.aspx">< Back to List</a>
        ...
        <asp:GridView runat="server" ID="gvShoppingCart" AutoGenerateColumns="false" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Remarks" ItemStyle-Width="25%">  
                    <ItemTemplate>
                        <asp:Label ID="lblRemarks" runat="server" Text='<%#Eval("ProdRemarks") %>'></asp:Label>
                    </ItemTemplate>  
                </asp:TemplateField> 
    ...
    <div class="container"> 
        <h1>
            <a href="#" data-toggle="tooltip" title="Total Quantity of this requirement ...">Total Qty :                
