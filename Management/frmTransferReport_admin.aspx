...
CodeFile="frmTransferReport_admin.aspx.cs" Inherits="FormsReport_Admin_frmTransferReport_Admin" %>
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td style="text-align: Left; font-family: Arial; " 
                    class="style40">
                    <asp:RadioButton ID="RadioButton2" runat="server" Text="Transfer Summary" 
                    GroupName="Sales" 
                    OnCheckedChanged="RadioButtonSales_CheckedChanged" 
                    AutoPostBack="true" />
                </td>
