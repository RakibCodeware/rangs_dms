...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <%--Dealer and Showroom,Model,Qty wise data--%>
    <div class="row">
         <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
               <%-- <img src="~/Images/newicon.png" style="width:10px;height:10px" />--%>
                <%--<asp:ImageButton ID="ImageButton12" ImageUrl="~/Images/newicon.png" ImageAlign="Left"
                                        runat="server" TabIndex="1" />--%>
                    <b style="color:orange">(**NEW**)</b> Model Wise Showroom Sales on &nbsp;
                ...
                <div class="panel-body" style="height: 400px; overflow: scroll">
                        ...
                        <table width ="100%">
                            <tr>                                
                                ...
                                <td>:</td>
                                <td>
                                    <asp:TextBox ID="TextBox1" runat="server" Width="90px" TabIndex="1" 
                                        ToolTip="Date Format (MM/dd/yyyy)" MaxLength="10">
                                    </asp:TextBox> 
                                    <cc1:calendarextender ID="Calendarextender16" PopupButtonID="ImageButton3" runat="server" TargetControlID="TextBox1"
                                        Format="MM/dd/yyyy">
                                    </cc1:calendarextender>
                                                    
                                    <asp:ImageButton ID="ImageButton3" ImageUrl="~/Images/cal.gif" ImageAlign="AbsMiddle"
                                        runat="server" TabIndex="1" />
                                </td>
                                <td></td>
                                <td>To Date</td>
                                <td>:</td>
                                <td>
                                    <asp:TextBox ID="TextBox2" runat="server" Width="90px" TabIndex="2" 
                                            ToolTip="Date Format (MM/dd/yyyy)" MaxLength="10"></asp:TextBox> 
                                    <cc1:calendarextender ID="Calendarextender17" PopupButtonID="ImageButton7" runat="server" TargetControlID="TextBox2"
                                        Format="MM/dd/yyyy">
                                    </cc1:calendarextender>
                
                                    <asp:ImageButton ID="ImageButton7" ImageUrl="~/Images/cal.gif" ImageAlign="AbsMiddle"
                                        runat="server" TabIndex="1"  />
                                </td>
                                <td align="left">
                                    <asp:ImageButton ID="ImageButton8" runat="server" Height="18px" 
                                        ImageUrl="~/Images/search.png" Width="18px" 
                                        data-toggle="tooltip" title="Click here for Search data ..." onclick="ImageButton8_Click"
                                    /> 
                                </td>
                            </tr>
                        </table>
                    ...
                    <div>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Date" HeaderText="Date" />
                                <asp:BoundField DataField="eName" HeaderText="Dealer" />
                                <asp:BoundField DataField="GroupName" HeaderText="Category Name" />   
                                <asp:BoundField DataField="Model" HeaderText="Model" />                                               
                                <asp:BoundField DataField="tQty" HeaderText="Sales Qty" />
                                <%--<asp:BoundField DataField="tAmnt" HeaderText="Sales Amnt" />       --%>                       
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <b style="color:orange">(**NEW**)</b> Model Wise Dealer Sales on &nbsp;
                ...
                <div class="panel-body" style="height: 400px; overflow: scroll">
                        ...
                        <table width ="100%">
                            <tr>                                
                                ...
                                <td>:</td>
                                <td>
                                    <asp:TextBox ID="TextBox5" runat="server" Width="90px" TabIndex="1" 
                                        ToolTip="Date Format (MM/dd/yyyy)" MaxLength="10">
                                    </asp:TextBox> 
                                    <cc1:calendarextender ID="Calendarextender18" PopupButtonID="ImageButton9" runat="server" TargetControlID="TextBox5"
                                        Format="MM/dd/yyyy">
                                    </cc1:calendarextender>
                                                    
                                    <asp:ImageButton ID="ImageButton9" ImageUrl="~/Images/cal.gif" ImageAlign="AbsMiddle"
                                        runat="server" TabIndex="1" />
                                </td>
                                <td></td>
                                <td>To Date</td>
                                <td>:</td>
                                <td>
                                    <asp:TextBox ID="TextBox6" runat="server" Width="90px" TabIndex="2" 
                                            ToolTip="Date Format (MM/dd/yyyy)" MaxLength="10"></asp:TextBox> 
                                    <cc1:calendarextender ID="Calendarextender19" PopupButtonID="ImageButton10" runat="server" TargetControlID="TextBox6"
                                        Format="MM/dd/yyyy">
                                    </cc1:calendarextender>
                
                                    <asp:ImageButton ID="ImageButton10" ImageUrl="~/Images/cal.gif" ImageAlign="AbsMiddle"
                                        runat="server" TabIndex="1"  />
                                </td>
                                <td align="left">
                                    <asp:ImageButton ID="ImageButton11" runat="server" Height="18px" 
                                        ImageUrl="~/Images/search.png" Width="18px" 
                                        data-toggle="tooltip" title="Click here for Search data ..." onclick="ImageButton11_Click"
                                    /> 
                                </td>
                            </tr>
                        </table>
                    ...
                    <div>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Date" HeaderText="Date" />
                                <asp:BoundField DataField="eName" HeaderText="Showroom" />
                                <asp:BoundField DataField="GroupName" HeaderText="Category Name" />   
                                <asp:BoundField DataField="Model" HeaderText="Model" />                                               
                                <asp:BoundField DataField="tQty" HeaderText="Sales Qty" />
                               <%-- <asp:BoundField DataField="tAmnt" HeaderText="Sales Amnt" />    --%>                          
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="height: 180px; overflow: scroll">
                    <p>
                        <b>
