...
AutoEventWireup="true" CodeFile="Ctp_Info.aspx.cs" Inherits="FormsReport_Admin_Ctp_Info" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h4 class="col-sm-12 bg-primary" style="padding:5px"> CTP/Dealer Information ...</h4>
    <p></p>
                ...
                <td>
                    <asp:GridView ID="gvCustomres" runat="server"                        
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="eDESC" HeaderText="CTP Address" />
                            <asp:BoundField DataField="ContactPerson" HeaderText="Contact Person" />
                            <asp:BoundField DataField="Desg" HeaderText="Designation" />
                            <asp:BoundField DataField="Status" HeaderText="CTP Status" />                            
