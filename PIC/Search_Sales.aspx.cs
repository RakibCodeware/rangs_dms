...
public partial class Search_Sales_info : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        sSql = sSql + " dbo.MRSRMaster.EntryDate";
        ...
        if (ddlFromTime.SelectedItem.Text != "00:00:00")
        {
            sSql = sSql + " AND (dbo.MRSRMaster.EntryDate >= '" + this.txtFrom.Text + " " + ddlFromTime.SelectedItem.Text + "'";
            sSql = sSql + " AND dbo.MRSRMaster.EntryDate <= '" + this.txtToDate.Text + " " + ddlToTime.SelectedItem.Text + "')";
        }
        else
        {
