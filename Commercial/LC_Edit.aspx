<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LC_Edit.aspx.cs" Inherits="LC_Edit" 
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" 
        style="padding:5px; background-color: #CC0000;" align="center"> L/C Information Edit/Update ...</h2>
    <p>
            ...
            <tr>
                ...
                <td style="text-align: left" class="style4">
                    <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" 
                        ...
                        Font-Size="Small" 
                        ToolTip="Click here for Search LC details ..." TabIndex="1" 
                        BackColor="#CC6600"/>
                </td>  
