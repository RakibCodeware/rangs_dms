...
public partial class Search_Del : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        //Session["AssAID"] = GridView1.DataKeys[gRow.RowIndex].Value.ToString();
        Session["sDONo"] = GridView1.DataKeys[gRow.RowIndex].Value.ToString();
    ...
    private void fnLoadData_Model()
    {
        ...
        string sSql = "";
        sSql = "SELECT dbo.MRSRMaster_TM.MRSRCode, CONVERT(varchar(12), dbo.MRSRMaster_TM.TDate, 105) AS TDate,";
        sSql = sSql + " dbo.MRSRMaster_TM.LCNO, dbo.MRSRMaster_TM.LCDate, dbo.MRSRMaster_TM.ShipFrom, ";
        sSql = sSql + " CONVERT(varchar(12), dbo.MRSRMaster_TM.ShipDate, 105) AS ShipDate, ";
        sSql = sSql + " SUM(dbo.MRSRDetails_TM.Qty) AS tQty, dbo.Product.Model";
        ...
        sSql = sSql + " INNER JOIN dbo.Product ON dbo.MRSRDetails_TM.ProductID = dbo.Product.ProductID";

        sSql = sSql + " WHERE TrType=2";
        sSql = sSql + " AND (dbo.MRSRMaster_TM.TDate>='" + txtFrom.Text + "'";
        sSql = sSql + " AND dbo.MRSRMaster_TM.TDate<='" + txtToDate.Text + "')";

        if (txtLCNo.Text.Length != 0)
        {
            sSql = sSql + " AND (dbo.MRSRMaster_TM.MRSRCode='" + txtLCNo.Text + "')";
        }
        ...
        sSql = sSql + " GROUP BY dbo.MRSRMaster_TM.MRSRCode, dbo.MRSRMaster_TM.TDate,";
        sSql = sSql + " dbo.MRSRMaster_TM.LCNO, dbo.MRSRMaster_TM.LCDate, dbo.MRSRMaster_TM.ShipFrom,";
        sSql = sSql + " dbo.MRSRMaster_TM.ShipDate, dbo.Product.Model";

        sSql = sSql + " ORDER BY dbo.MRSRMaster_TM.TDate, dbo.MRSRMaster_TM.MRSRCode";
    ...
    private void fnLoadData_LC()
    {
        ...
        sSql = sSql + " dbo.MRSRMaster_TM.LCNO, dbo.MRSRMaster_TM.LCDate, dbo.MRSRMaster_TM.ShipFrom, ";
        sSql = sSql + " CONVERT(varchar(12), dbo.MRSRMaster_TM.ShipDate, 105) AS ShipDate, ";
        sSql = sSql + " SUM(dbo.MRSRDetails_TM.Qty) AS tQty";
        ...
        sSql = sSql + " GROUP BY dbo.MRSRMaster_TM.MRSRCode, dbo.MRSRMaster_TM.TDate,";
        sSql = sSql + " dbo.MRSRMaster_TM.LCNO, dbo.MRSRMaster_TM.LCDate, dbo.MRSRMaster_TM.ShipFrom,";
        sSql = sSql + " dbo.MRSRMaster_TM.ShipDate";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            CalcTotalQty(e.Row.Cells[5].Text);
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[5].Text = runningTotalQty.ToString("0,0", CultureInfo.InvariantCulture);
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            CalcTotalQty(e.Row.Cells[6].Text);
            //CalcTotal_TP(e.Row.Cells[3].Text);
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[6].Text = runningTotalQty.ToString("0,0", CultureInfo.InvariantCulture);
