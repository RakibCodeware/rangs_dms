...
public partial class DO_Edit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (txtCHNo.Text == "")
        {
            PopupMessage("Please enter D/O Number.", btnSave);
            txtCHNo.Focus();
            return;
        }
        ...
        tSDate = Convert.ToDateTime(this.txtDate.Text);
        ...
        */
        ...
        sSql = "INSERT INTO MRSRMaster_TM(MRSRCode,POCode,TDate," +
                " TrType,LCNO,InvoiceNo,UserID,EntryDate" +
                " )" +
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        sSql = "SELECT MRSRMID, MRSRCode, ShipFrom, " +
            ...
            " FROM MRSRMaster_TM " +
            " WHERE (MRSRCode = '" + this.txtCHNo.Text + "') AND TrType=2";
        ...
        if (dr.Read())
        {
            ...
            this.txtLCNo.Text = Convert.ToString(dr["LCNO"].ToString());
