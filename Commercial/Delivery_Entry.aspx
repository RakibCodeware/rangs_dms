<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Delivery_Entry.aspx.cs" Inherits="Commercial_Delivery_Entry" 
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" 
        style="padding:5px; background-color: #800000; color: #FFFFFF;" align="center"> Delivery Entry ...</h2>
    <p>
            ...
            <tr>
                ...
                <td style="text-align: left" class="style4">
                    <asp:TextBox ID="txtCHNo" runat="server" Width="200px" 
                        ...
                        style="font-weight: 700" ToolTip="Please Enter LC Number" 
                        MaxLength="15" Enabled="true" >
                    </asp:TextBox>
                </td>
                <td class="style5"> </td>                 
                
                <td class="style6" align="left">DO Date</td>
                <td class="style7">:</td>
                <td class="style8" align="left">
                    <asp:TextBox ID="txtDate" runat="server" Width="110px" TabIndex="0"                         
