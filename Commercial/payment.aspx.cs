...
public partial class payment : System.Web.UI.Page
{
    ...
    protected void fnLoadData()
    {
        ...
        sSql = sSql + " BranchName, DepositAmnt, DepositType, DepositBy, Remarks";
        sSql = sSql + " FROM tbPayment_commercial ";
    ...
    protected void btnSaveClick(object sender, EventArgs e)
    {
        ...
        sSql = "";
        sSql = "SELECT RefAID FROM tbPayment_commercial" +
        ...
        sSql = "";
        sSql = "INSERT INTO tbPayment_commercial(RefNo,DepositDate,EID," +
               "BankID,BankName,BranchName,DepositAmnt,DepositType,DepositBy,Remarks,UserID,EntryDate)" +
    ...
    protected void fnLoadAutoBillNo()
    {
        ...
        sSql = "SELECT ISNULL(MAX(RIGHT(RefNo, 5)), 0) AS RefNo" +
            " FROM dbo.tbPayment_commercial" +
            " WHERE (LEFT(RefNo, 11) = '" + DateTime.Now.ToString("yyyy") + "-" + "')";
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " FROM dbo.tbPayment_commercial";
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //UPDATE DATA
        string sSql = "";
        sSql = "UPDATE tbPayment_commercial SET BankName='" + this.DropDownList1.SelectedItem.Text + "',";
    ...
    protected void lnkDel_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        sSql = "";
        sSql = "DELETE FROM tbPayment_commercial";
