...
public partial class Search_PettyCash : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        string sSql = "";
        sSql = "SELECT RefAID, RefNo, CONVERT(VARCHAR(10), ExpenseDate, 103) AS ExpenseDate, tbPettyCash.LeadgerID, ";
        sSql = sSql + " AccLeadger.LeadgerName, LDesc, ExpenseAmnt, ExpenseBy, Remarks, eName";

        sSql = sSql + " FROM  dbo.tbPettyCash INNER JOIN ";
        sSql = sSql + " dbo.Entity ON dbo.tbPettyCash.EID = dbo.Entity.EID INNER JOIN";
        sSql = sSql + " dbo.AccLeadger ON dbo.tbPettyCash.LeadgerID = dbo.AccLeadger.LeadgerID";
        ...
        {
            sSql = sSql + " WHERE (ExpenseDate >= '" + Convert.ToDateTime(this.txtFrom.Text) + "'";
            sSql = sSql + " AND ExpenseDate <= '" + Convert.ToDateTime(this.txtToDate.Text) + "')";
            //sSql = sSql + " AND (EID='" + Session["EID"] + "')";

            if (ddlParticulars.SelectedItem.Text != "ALL")
            {
                sSql = sSql + " AND (AccLeadger.LeadgerName = '" + ddlParticulars.SelectedItem.Text + "')";
            }
        ...
        sSql = sSql + " ORDER BY ExpenseDate Desc";
    ...
    private void fnLoadCombo_Item(DropDownList xCombo, string pField, string pFieldID, string pTable)
    {
        ...
        try
        {
            ...
            //Add blank item at index 0.
            xCombo.Items.Insert(0, new ListItem("ALL", "0"));
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            this.txtDesc.Text = dr["LDesc"].ToString();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " LeadgerID='" + this.DropDownList1.SelectedItem.Value + "',";
        sSql = sSql + " LDesc='" + this.txtDesc.Text + "',";
