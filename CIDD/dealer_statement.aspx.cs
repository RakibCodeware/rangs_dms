...
public partial class dealer_statement : System.Web.UI.Page
{
    ...
    // LOAD Dealer Area/ Zone Name
    public void fnLoadZoneName()
    {
        ...
        sSql = "";
        sSql = "SELECT CatName FROM dbo.Zone Where ZoneType=1 GROUP BY CatName ";
    ...
    protected void SearchData(object sender, EventArgs e)
    {
        ...
        if (DropDownList1.SelectedItem.Text == "ALL")
        {
            ScriptManager.RegisterStartupScript(this, typeof(Page), "Alert",
                            "<script>alert('" + "Please Select Zone/Area Name" + "');</script>", false);
            //txtCHNo.Focus();
            return;
        }
    ...
    private void fnLoadData()
    {
        ...
        sSql = sSql + " WHERE (dbo.MRSRMaster.TrType = 3) AND (dbo.Zone.CatName = '" + DropDownList1.SelectedItem.Text  + "') ";
        ...
        sSql = sSql + " AND (dbo.Zone.CatName='" + DropDownList1.SelectedItem.Text + "')";
    ...
    */
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        String strQuery = "SELECT CategoryID,DAID,Name,ZoneName FROM VW_Delear_Info ";
        strQuery = strQuery + " WHERE (Discontinue = 'No') AND (ZoneName='" + DropDownList1.SelectedItem.Text + "')";
        strQuery = strQuery + " ORDER BY Name";
        //SqlConnection con = new SqlConnection("conn");
        SqlCommand cmd = new SqlCommand(strQuery, conn);
        //SqlCommand cmd = new SqlCommand();
