...
public partial class Admin_Att_Report_EmpWise : System.Web.UI.Page
{
    ...
    string strCon = "Data Source=(local);Initial Catalog=HRMS;Integrated Security=SSPI;User Id=sa;Password=Adminn321;Min Pool Size=5;Max Pool Size=60;Connect Timeout=0";
    ...
    protected void LoadDropDownList_Employee()
    {
        ...
        strQuery = strQuery + " AND (dbo.Dept.DeptNm = 'Sales')";
