<%@ Page Language="C#" MasterPageFile="~/Admin_Report.master" AutoEventWireup="true" CodeFile="frmSalesReport_admin.aspx.cs" Inherits="FormsReport_Admin_frmSalesReport_Admin" %>
            ...
            <tr>
                <td align="center">                        
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="2"  
                        OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="450px" 
                        ...
                        <Columns>
                            <asp:TemplateField Visible="true">
                                <ItemTemplate><asp:LinkButton runat="server" CommandName="select" ID="lnk_Select" Text="Select" /></ItemTemplate>
                            </asp:TemplateField>
