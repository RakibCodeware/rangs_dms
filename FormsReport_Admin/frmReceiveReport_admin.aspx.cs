...
public partial class FormsReport_Admin_frmReceiveReport_admin : System.Web.UI.Page
{
    ...
    private void fnLoadReceiveSummary_GroupWise()
    {
        ...
        sSql = "SELECT  dbo.Product.Model, dbo.Product.ProdName AS ProdDesc," +
