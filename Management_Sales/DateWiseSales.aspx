<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWiseSales.aspx.cs" 
Inherits="DateWiseSales" MasterPageFile="Admin.master"%>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-danger" 
        style="padding:5px; background-color: #008080; color: #FFFFFF;"> Date wise Sales of ...
    ...
    <div>        
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            DataKeyNames="TDate" GridLines="Vertical" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                ...
                <asp:BoundField DataField="WithAmnt" HeaderText="Withdrawn Amnt" 
                    HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="NetAmnt" HeaderText="Net Sales" 
                    HeaderStyle-HorizontalAlign="Center">                                               
