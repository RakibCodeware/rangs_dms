...
public partial class Search_DP : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        string sSql = "";
        sSql = "SELECT Entity, Model, ProdName, " +            
    ...
    private void fnLoadStatementData()
    {
        ...
        gSQL = gSQL + " AND  (dbo.Entity.SerialNo IS NOT NULL) ";
        //if (cboGroup1.text != "ALL") 
        //{
        //    gSQL = gSQL + " AND dbo.Product.GroupName='" & cboGroup1.text & "'";
        //}
