        ...
        <table width="100%">
            ...
            <tr>
                ...
                <asp:TextBox ID="txtOldPass" runat="server" TextMode="Password" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter Old Password" MaxLength="12"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <asp:TextBox ID="txtNewPass" runat="server" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter New Password" MaxLength="12" TextMode="Password"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <asp:TextBox ID="txtConfirmPass" runat="server" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter Confirm Password" MaxLength="12" TextMode="Password" 
                        ></asp:TextBox>
                </td>
