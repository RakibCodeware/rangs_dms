...
CodeFile="issue_delivery.aspx.cs" Inherits="issue_delivery" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" 
        style="padding:5px; background-color: #008080;" align="center"> Showroom Issue/Delivery Entry ...</h2>
    <p>
    ...
    <div align="center">
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td class="style6" align="left">Challan Date</td>
                <td class="style7">:</td>
            ...
            <tr>
                <td class="style1"></td>
                <td class="style2" align="left">Issue/Delivery To</td>
                <td class="style3">:</td>
            ...
            <tr>
                ...
                <td class="style7"></td>
                <td class="style8">
                    <asp:Label ID="lblProdSerial" runat="server" Text="-" Visible="False"></asp:Label>
                </td>
                <td class="style9"></td>               
            </tr>
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                <td colspan="1" align="left">  
                    <asp:Label ID="Label1" runat="server" Text="Note/Remarks:"></asp:Label> 
                    &nbsp;
                    <asp:TextBox ID="txtNote" CssClass="form-control" runat="server" 
