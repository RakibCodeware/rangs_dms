...
public partial class search_transfer : System.Web.UI.Page
{
    ...
    protected void LoadDropDownList_CTP()
    {
        ...
        strQuery = strQuery + " ORDER BY Entity_2.eName";
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        if (Session["sBrId"].ToString() == "370")
        {
            ...
            Session["sIssueChNo"] = GridView1.DataKeys[gRow.RowIndex].Value.ToString();
            //Session["sBillNo"] = this.txtInvoiceNo.Text;
            Session["sReportType"] = "RPT_Issue_Bill";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " WHERE (dbo.MRSRMaster.TrType = '" + iTrType + "') ";
    ...
    private void fnLoadData()
    {
        ...
        {
            sSql = sSql + " AND (dbo.MRSRMaster.InSource='" + ddlEntity.SelectedItem.Value + "')";
        }
