...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server" >
    ...
    <table width ="100%">
        ...
        <tr>
            ...
            <td align="left"></td>
            <td>                
                <asp:DropDownList ID="ddlCTP" runat="server" class="form-control" Visible="False"> 
                </asp:DropDownList>
            </td>
        </tr>
    ...
    <br />
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="DelID"            
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DelFrom" HeaderText="Del_From" SortExpression="DelFrom" />                
        ...
        <asp:Panel ID="pnlpopup" runat="server"  BackColor="White" Height="550px" Width="700px" style="display:none">
            ...
            <table width="100%"  cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td></td>                    
                    <td colspan="4">                        
                        <asp:Button ID="btnUpdate" onclick="btnUpdate_Click" CssClass="btn btn-primary"  Width="100px" runat="server" Text="Update" Visible="False" />
                        
                        <asp:Button ID="btnSendMail" onclick="btnSendMail_Click" CssClass="btn btn-warning"  Width="100px" runat="server" Text="Mail Re-Send" Visible="False" />
