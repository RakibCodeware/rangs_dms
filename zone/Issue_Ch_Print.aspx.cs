...
public partial class Issue_Ch_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            crv.SelectionFormula = "{VW_Issue_Online.MRSRCode} ='" + Session["sIssueChNo"].ToString() + "'";
            //rptDoc.Load(reportPath); 
            reportPath = Server.MapPath("IssueChallan.rpt");
