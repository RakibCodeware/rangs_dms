...
public partial class Transfer_Ch_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //crv.SelectionFormula = "{VW_Transfer_Online.MRSRCode} ='" + this.ddlContinents.SelectedValue + "'";
            crv.SelectionFormula = "{VW_Transfer_Online.MRSRCode} ='" + Session["sTrChNo"].ToString() + "'";
            //rptDoc.Load(reportPath); 
            reportPath = Server.MapPath("TransferChallan.rpt");
    ...
    {
        Response.Redirect("Search_Transfer.aspx");
    }
