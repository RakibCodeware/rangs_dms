<%@ Page Language="C#" MasterPageFile="~/CTP_Admin.master" AutoEventWireup="true" CodeFile="frmSalesReport.aspx.cs" Inherits="FormsReport_frmSalesReport" %>
            ...
            <tr>
                <td align="center">                        
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="2"  
                        OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="350px" 
