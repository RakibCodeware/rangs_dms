...
CodeFile="ChangePassword.aspx.cs" Inherits="Forms_ChangePassword" MasterPageFile="Admin.master"%>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="style21" align="left">-
                    <span style="color: rgb(40, 71, 117); font-family: Verdana; font-size: 9px; 
            ...
            <tr>
                ...
                <asp:TextBox ID="txtOldPass" runat="server" TextMode="Password" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter Old Password" MaxLength="50"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <asp:TextBox ID="txtNewPass" runat="server" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter New Password" MaxLength="50" TextMode="Password"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td style="text-align: left" class="style28">
                    <asp:TextBox ID="txtConfirmPass" runat="server" Width="193px" TabIndex="1" 
                        ToolTip="Please Enter Confirm Password" MaxLength="50" TextMode="Password" 
                        ></asp:TextBox>
                </td>
