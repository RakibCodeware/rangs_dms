...
public partial class sales_delivery_test : System.Web.UI.Page
{
    ...
    protected void LoadOfferTypeList()
    {
        ...
        ddlOfferType.Items.Insert(0, new ListItem("None", "None"));
    ...
    protected void LoadDealerTypeList()
    {
        ...
        ddlDealerType.Items.Insert(2, new ListItem("Credit Dealer", "Credit Dealer"));
    }
    ...
    protected void txtQty_TextChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            var specialPriceCatwise = new[]
            {
                ...
                new { OfferPrice = 109900,Qty=100,  Model = "KELVINATOR REFRIGERATOR",DType="Cash Dealer",offerType="Regular",PType="",disper=0 },
                new { OfferPrice = 194900,Qty=100, Model = "REFRIGERATOR(FROST)" ,DType="Cash Dealer",offerType="Regular",PType="",disper=0},//rangs
