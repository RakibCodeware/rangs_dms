...
public partial class sales_delivery : System.Web.UI.Page
{
    ...
    protected void LoadOfferTypeList()
    {
        ddlOfferType.Items.Clear();
        ddlOfferType.Items.Insert(0, new ListItem("Regular", "Regular"));
        //ddlOfferType.Items.Insert(1, new ListItem("Online", "Online"));
        ddlOfferType.Items.Insert(1, new ListItem("Special Price", "Special Price"));
        ddlOfferType.Items.Insert(2, new ListItem("Special Offer(Package)", "Special Offer(Package)"));
        ddlOfferType.Items.Insert(3, new ListItem("Online Price(5%)", "Online Price(5%)"));
        //ddlOfferType.Items.Insert(3, new ListItem("Regular", "Regular"));
    }
    protected void LoadDealerTypeList()
    {
        ddlDealerType.Items.Clear();
        //ddlDealerType.Items.Insert(0, new ListItem("None", "None"));
        ddlDealerType.Items.Insert(0, new ListItem("Credit Dealer", "Credit Dealer"));
        ddlDealerType.Items.Insert(1, new ListItem("Cash Dealer", "Cash Dealer"));
    ...
    protected void LoadProductGroupList()
    {
        ...
        String strQuery = "select GroupSL, GroupName from Product" +
           " where GroupSL not in (2,3,4,7,8,9,10,11,12,13,14,15,20,21,22,24,26,27,31,32,33,34,38,40,43,52,57," +
           "60,61,81,82,90,91,92,94,95,103,105,106,108,109,110,111,112)" +
           "GROUP BY GroupSL, GroupName ORDER BY GroupName";//71,53,41,54,55,56
        // 1,19,50,58,62,63,64,65,66,67,101,102,
    ...
    protected void ddlDealerType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlDealerType.Enabled = false;
        ddlDealerType.CssClass = "form-control";
    }
    protected void ddlOfferType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlOfferType.CssClass = "form-control";
    }
    protected void ddlProductGroup_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlProductGroup.CssClass = "form-control";
    }
    ...
    protected void ddlContinents_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        sSql = "SELECT ProductID,ProdName,UnitPrice,Model,Code,GroupName,";
    ...
    //            UP = Convert.ToDouble(this.txtUP.Text);
    ...
    protected void txtQty_TextChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //this.txtDisAmnt.Text = "0";
            //this.txtWithAdj.Text = "0";
            var packagePriceModelWise = new[]
            {
                new { OfferPrice = 29500,Qty=60, Model = "32LQ636B",diser=0 },
                new { OfferPrice = 29500,Qty=10, Model = "32LQ636B" ,diser=0},
                new { OfferPrice = 30000,Qty=5,  Model = "32LQ636B",diser=0 },
                new { OfferPrice = 30500,Qty=3, Model = "32LQ636B" ,diser=0},
                new { OfferPrice = 31000,Qty=1, Model = "32LQ636B" ,diser=0},
                new { OfferPrice = 47000,Qty=3,  Model = "43UP7551",diser=0 },
                new { OfferPrice = 47500,Qty=1, Model = "43UP7551" ,diser=0},
                //new { OfferPrice = 449900,Qty=100,  Model = "86NANO75",diser=0},
                //new { OfferPrice = 224900,Qty=100,  Model = "OLED55C1",diser=0 },
                //new { OfferPrice = 384900,Qty=100,  Model = "OLED65C1" ,diser=0},
                //new { OfferPrice = 374900,Qty=100,  Model = "OLEC65A1" ,diser=0},
                //new { OfferPrice = 649900,Qty=100,  Model = "OLED77C1" ,diser=0},
                //new { OfferPrice = 269900,Qty=100, Model = "GS-Q6472NS",diser=0 },
                //new { OfferPrice = 229900,Qty=100,  Model = "GS-B6432WB",diser=0 },
                //new { OfferPrice = 89900,Qty=100,  Model = "2B502HXHL" ,diser=0},
             
                //new { OfferPrice = 83900,Qty=100,  Model = "2B432HLHL",diser=0 },
                //new { OfferPrice = 79900,Qty=100,  Model = "FV1409S4W",diser=0 },
                //new { OfferPrice = 99900,Qty=100,  Model = "FV1409H3W",diser=0 },
                //new { OfferPrice = 37990,Qty=100,  Model = "WW-172EP" ,diser=0},
                //new { OfferPrice = 29990,Qty=100,  Model = "WW-151NP",diser=0 },
                //new { OfferPrice = 25990,Qty=100,  Model = "WW-140NP" ,diser=0},
                //new { OfferPrice = 16900,Qty=100,  Model = "MH-6565DIS",diser=0 },
                //new { OfferPrice = 24900,Qty=100,  Model = "MS-2336GIB" ,diser=0},
                //new { OfferPrice = 10900,Qty=100,  Model = "HBS-FN7/B,W-10",diser=0 },
                //new { OfferPrice = 9900, Qty=100, Model = "HBS-FN6/B,W-9",diser=0 },
            }.ToList();

            var specialPriceCatwise = new[]
            {
                new { OfferPrice = 50900,Qty=100, Model = "LG LCD TV",DType="Cash Dealer",offerType="Regular",PType="",disper=12},
                new { OfferPrice = 79900,Qty=100, Model = "RANGS LCD TV" ,DType="Cash Dealer",offerType="Regular",PType="",disper=12},
                new { OfferPrice = 339900,Qty=100, Model = "SONY LCD TV" ,DType="Cash Dealer",offerType="Regular",PType="Cash Dealer",disper=12},

                new { OfferPrice = 50900,Qty=100, Model = "LG LCD TV",DType="Credit Dealer",offerType="Regular",PType="",disper=10},
                new { OfferPrice = 79900,Qty=100, Model = "RANGS LCD TV" ,DType="Credit Dealer",offerType="Regular",PType="",disper=10},
                new { OfferPrice = 339900,Qty=100, Model = "SONY LCD TV" ,DType="Credit Dealer",offerType="Regular",PType="",disper=10},

                new { OfferPrice = 109900,Qty=100,  Model = "KELVINATOR REFRIGERATOR",DType="Cash Dealer",offerType="Regular",PType="",disper=18 },
                new { OfferPrice = 194900,Qty=100, Model = "REFRIGERATOR(FROST)" ,DType="Cash Dealer",offerType="Regular",PType="",disper=18},//rangs

                 new { OfferPrice = 109900,Qty=100,  Model = "KELVINATOR REFRIGERATOR",DType="Credit Dealer",offerType="Regular",PType="",disper=16 },
                new { OfferPrice = 194900,Qty=100, Model = "REFRIGERATOR(FROST)" ,DType="Credit Dealer",offerType="Regular",PType="",disper=16},//rangs

                new { OfferPrice = 109900,Qty=100,  Model = "KELVINATOR FREEZER",DType="Cash Dealer",offerType="Regular",PType="",disper=18 },
                new { OfferPrice = 194900,Qty=100, Model = "RANGS FREEZER" ,DType="Cash Dealer",offerType="Regular",PType="",disper=18},//rangs

                 new { OfferPrice = 109900,Qty=100,  Model = "KELVINATOR FREEZER",DType="Credit Dealer",offerType="Regular",PType="",disper=16 },
                new { OfferPrice = 194900,Qty=100, Model = "RANGS FREEZER" ,DType="Credit Dealer",offerType="Regular",PType="",disper=16},//rangs


                new { OfferPrice = 159900,Qty=100, Model = "LG-OVEN" ,DType="",offerType="Regular",PType="Cash Dealer",disper=0},
                
                new { OfferPrice = 299900,Qty=100,  Model = "RANGS AC",DType="Cash Dealer",offerType="Regular",PType="Cash Dealer",disper=12 },
                new { OfferPrice = 384900,Qty=100,  Model = "KELVINATOR AC" ,DType="Cash Dealer",offerType="Regular",PType="",disper=12},
                
                new { OfferPrice = 449900,Qty=100,  Model = "WASHING MACHINE",DType="Cash Dealer",offerType="Regular",PType="Cash Dealer",disper=0},
                new { OfferPrice = 224900,Qty=100,  Model = "LG-WATER PURIFIER",DType="Cash Dealer",offerType="Regular",PType="",disper=0 },
                
                new { OfferPrice = 374900,Qty=100,  Model = "LG-REFRIGERATOR" ,DType="Cash Dealer",offerType="Regular",PType="",disper=0},
                new { OfferPrice = 649900,Qty=100,  Model = "SONY Hi-Fi" ,DType="Cash Dealer",offerType="Regular",PType="",disper=0},
                
            }.ToList();

            if (this.ddlOfferType.SelectedValue == "Regular")
            {
                foreach (var item in specialPriceCatwise)
                {
                    if (lblGroupName.Text==item.Model && this.ddlDealerType.SelectedValue==item.DType && this.ddlOfferType.SelectedValue==item.offerType)
                    {

                        this.txtWithAdj.Text = "0";
                        double x = Math.Floor(tAmnt * item.disper / 100);
                        this.txtWithAdj.Text = Convert.ToString(x);
                        this.txtWithAdj.Enabled = false;
                        break;
                    }
                }
            ...
            else if (this.ddlOfferType.SelectedValue == "Special Offer(Package)")
	        {
                foreach (var item in packagePriceModelWise)
                {
                    if (this.ddlContinents.SelectedItem.Text == item.Model && this.ddlDealerType.SelectedValue == "Cash Dealer")
                    {
                        if (this.txtQty.Text == item.Qty.ToString())
                        {
                            txtCP.Text = item.OfferPrice.ToString();
                            tAmnt = Convert.ToDouble(txtCP.Text)*item.Qty;
                            this.txtTotalAmnt.Text = Convert.ToString(tAmnt);
                            this.txtWithAdj.Text = "0";
                            //double x = Math.Floor(tAmnt * item.disper / 100);
                            //this.txtWithAdj.Text = Convert.ToString(x);
            ...
            {
                this.txtWithAdj.Text = "0";
                if (this.ddlOfferType.SelectedValue=="Online Price(5%)")
                {
                    this.txtWithAdj.Enabled = true;
                }
                else
                {
                    this.txtWithAdj.Enabled = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (this.txtRefDeposit.Text == "")
        {
            PopupMessage("Please Enter Reference Deposit No.", btnSave);
            txtRefDeposit.Focus();
            return;
        }
        else
        {
            string depositRef = this.txtRefDeposit.Text.Trim();
            decimal depositAmnt = 0, refTotalAmnt = 0;

            /// ------------ Get Deposit Amount ------------------------------
            sSql = "";
            sSql = "SELECT DepositAmnt FROM DepositAmnt" +
                " WHERE CollectionNo='" + depositRef + "'";
            SqlCommand cmd5 = new SqlCommand(sSql, conn);
            cmd5 = new SqlCommand(sSql, conn);
            conn.Open();
            SqlDataReader dr11 = cmd5.ExecuteReader();
            if (dr11.Read())
            {
                depositAmnt = Convert.ToDecimal(dr11["DepositAmnt"].ToString());
            }
            dr11.Dispose();
            dr11.Close();
            conn.Close();
            ...
            // ------------ Get Reference Challan Amnt for Ref. Deposit -------
            sSql = "";
            sSql = "SELECT ISNULL(SUM(NetSalesAmnt),0) NetSalesAmnt FROM  MRSRMaster" +
                " WHERE BLNo like '%" + depositRef + "'";
            SqlCommand cmd6 = new SqlCommand(sSql, conn);
            cmd6 = new SqlCommand(sSql, conn);
            conn.Open();
            SqlDataReader dr12 = cmd6.ExecuteReader();
            if (dr12.Read())
            {
                refTotalAmnt = Convert.ToDecimal(dr12["NetSalesAmnt"].ToString());
            }
            dr12.Dispose();
            dr12.Close();
            conn.Close();
            ...
            decimal netSales = Convert.ToDecimal(this.txtNetAmnt.Text);

            decimal percent = ((decimal)depositAmnt / ((decimal)netSales + (decimal)refTotalAmnt)) * 100;


            //if (this.ddlDealerType.SelectedValue == "Cash Dealer")
            //{
            //    if (percent < 100)
            //    {
            //        PopupMessage("Please deposit at least 100% of Invoice Amount.", btnSave);
            //        txtRefDeposit.Focus();
            //        return;
            //    }

            //}
            //else if (this.ddlDealerType.SelectedValue == "Credit Dealer")
            //{
                if (ddlProductGroup.SelectedItem.Value == "58" ||
                ddlProductGroup.SelectedItem.Value == "1")
                {
                    if (percent < 60)
                    {
                        PopupMessage("Please deposit at least 60% of Invoice Amount.", btnSave);
                        txtRefDeposit.Focus();
                        return;
                    }
                }
                if (percent < 50)
                {
                    PopupMessage("Please deposit at least 50% of Invoice Amount.", btnSave);
                    txtRefDeposit.Focus();
                    return;
                }
            //}
        ...
        sSql = "INSERT INTO MRSRMaster(MRSRCode,TDate,TrType," +
               ...
               "Authorby,Issby,DeliveryFrom,Remarks,Tag,RefCHNo,POCode, AdvanceSales, BLNo" +
               " )" +
            " Values ('" + this.txtCHNo.Text + "','" + tDate + "','3'," +
            " '" + this.txtCHNo.Text + "','" + lblDealerID.Text + "','" + Session["sZoneID"] + "'," +
            ...
            " '" + iDelTag + "','" + txtRefChNo.Text + "','" + txtOrderNo.Text + "',1,'" + txtRefDeposit.Text + "'" +
        " )";
        ...
        //SAVE DATA IN MASTER TABLE OF DMS
        sSql = "";
        sSql = "INSERT INTO MRSRMaster(MRSRCode,TDate,TrType," +
               "InvoiceNo,InSource,OutSource," +
               "PayAmnt,DueAmnt,PayMode," +
               ...
               "Authorby,Issby,DeliveryFrom,Remarks,Tag,RefCHNo,POCode,AdvanceSales,BLNo" +
               " )" +
            " Values ('" + this.txtCHNo.Text + "','" + tDate + "','6'," +
        ...
        foreach (GridViewRow g1 in this.gvUsers.Rows)
        {
            ...
            gSql = "INSERT INTO MRSRDetails(MRSRMID,ProductID,Qty," +
                 ...
                 " '" + g1.Cells[16].Text + "','" + lblDealerID.Text + "','" + Session["sZoneID"] + "')";
            ...
            gSql = "INSERT INTO MRSRDetails(MRSRMID,ProductID,Qty," +
                 ...
                 " '" + g1.Cells[9].Text + "','" + g1.Cells[2].Text + "','" + g1.Cells[10].Text + "'," +
                 " '" + g1.Cells[13].Text + "','" + dIncAmnt + "','" + sIncType + "'," +
                 " '" + g1.Cells[16].Text + "','230','" + Session["EID"] + "')";
    ...
    protected void txtModel_TextChanged(object sender, EventArgs e)
    {
        ...
        double dBLIP = 0;
        double CampPrice = 0;
        double DealerSpecialPrice = 0;
        string sSql = "";

        sSql = "";
        sSql = "SELECT ProductID,ProdName,UnitPrice,Model,Code,GroupName,DealerSpecialPrice,DealerSpecialPriceExp,";
        sSql = sSql + " IncentiveType,BLIPAmnt,IncentiveAmnt,";
        sSql = sSql + " GetIncentive, ISNULL(WPPrice,0) AS WPPrice, ISNULL(BLIPofWP,0) AS BLIPofWP,";
        sSql = sSql + " ISNULL(WPIncentive,0) AS WPIncentive, ISNULL(WPMinQty,0) AS WPMinQty";
        sSql = sSql + " FROM Product";
        ...
        conn.Open();
        SqlDataReader dr = cmd.ExecuteReader();
        DateTime DealerSpecialPriceExp;
        try
        {
            if (dr.Read())
            {
                if (!string.IsNullOrEmpty(dr["DealerSpecialPriceExp"].ToString()))
                {
                    DealerSpecialPriceExp = Convert.ToDateTime(dr["DealerSpecialPriceExp"]);
                    if (DealerSpecialPriceExp >= DateTime.Now)
                    {
                        DealerSpecialPrice = Convert.ToDouble(dr["DealerSpecialPrice"].ToString());
                    }
                }
                this.txtCode.Text = dr["Code"].ToString();
                this.ddlContinents.SelectedItem.Text = dr["Model"].ToString();
        ...
        if (dr.Read())
        {
            if (DealerSpecialPrice > 0 && this.ddlDealerType.SelectedValue == "Cash Dealer" && this.ddlOfferType.SelectedValue == "Special Price")
            {
                CampPrice = DealerSpecialPrice;
            }
            else
            {
                CampPrice = UP - Convert.ToDouble(dr["DisAmnt"].ToString());
    ...
    //            this.txtProdDesc.Text = dr["ProdName"].ToString();
    //            //UP = Convert.ToDouble(dr["UnitPrice"].ToString());
    //            //UP = Convert.ToDouble(dr["DealerPrice"].ToString());
    //            //this.txtUP.Text = Convert.ToString(UP);
    //            this.txtUP.Text = dr["UnitPrice"].ToString();
    //            this.txtCP.Text = dr["DealerPrice"].ToString();
