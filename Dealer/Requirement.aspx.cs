...
public partial class Forms_Requirement : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        sSql = "";
        sSql = "INSERT INTO RequirmentMaster(ReqNo,ReqDate,DealerID,DealerCode,ReqFor," +
               "EID,UserID,EntryDate)" +
                     " Values ('" + this.txtCHNo.Text + "','" + tDate + "'," +
                     " '" + lblDealerID.Text + "','" + lblDealerCode.Text + "'," +                     
                     " '" + ddlDealerName.SelectedItem.Text + "'," +
                     " '" + Session["sBrId"] + "'," +
                     " '" + Session["UserName"] + "', " +
                     " '" + DateTime.Today + "'" +            
                     " )";
    ...
    private void fnSendMail_Invoice()
    {
        ...
        //---------------------------------------------------------
        string mailTo = "";
        if (Session["sMailTo"].ToString() == null)
        {
            mailTo = "cidd@rangs.com.bd";
        }
        else
        {
            mailTo = Session["sMailTo"].ToString();
        }
        ...
        mM2.To.Add(new MailAddress(mailTo));
        ...
        mM2.Body = mM2.Body + "<p><b>For : " + lblDealerName.Text + "</b><br/>";
        mM2.Body = mM2.Body + "Address : " + lblDealerAdd.Text + "<br/>";
        mM2.Body = mM2.Body + "Code: " + lblDealerCode.Text + "</p>";
