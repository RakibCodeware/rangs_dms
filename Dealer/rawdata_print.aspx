...
AutoEventWireup="true" CodeFile="rawdata_print.aspx.cs" Inherits="rawdata_print" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" style="padding:5px"> Raw Data ...</h2>

    <input id="btnPrint" type="button" value="Print" onclick="Print()" onclick="return btnPrint_onclick()" />
    &nbsp;&nbsp;&nbsp;
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="frmSalesReport_admin.aspx" Font-Names="Tahoma">Back to Sales Report</asp:HyperLink>
    ...
    <div id="dvReport">
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="~/Dealer/Reports/rptRawData.rpt">
                </Report>
