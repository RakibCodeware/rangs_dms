    ...
    <div align="center">
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td> Dealer Code:</td>
                <td align="left">
                    <asp:Label ID="lblDealerCode" runat="server" Text="0" Visible="True"></asp:Label>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtCode" runat="server" AutoPostBack="True" CssClass="form-control"
                        Width="300px" ontextchanged="txtCode_TextChanged">
                    </asp:TextBox>
                </td>
                <td align="left"></td>
            ...
            <tr>
                ...
                <td class="style20"> : </td>
                <td style="text-align: left" class="style21" >
                <asp:TextBox ID="txtRemarks" runat="server" Width="300px" CssClass="form-control"
