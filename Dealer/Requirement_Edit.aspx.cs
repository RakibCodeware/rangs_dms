...
public partial class Forms_Requirement_Edit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        sSql = "";
        sSql = "DELETE FROM RequirmentMaster" +
            " WHERE ReqAID='" + this.txtMRSRID.Text + "'";
        ...
        sSql = "";
        sSql = "DELETE FROM RequirmentDetails" +
            " WHERE ReqAID='" + this.txtMRSRID.Text + "'";
        //" AND OutSource='" + Session["sBrId"] + "'" +
        //" AND TrType=3";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //LOAD MASTER DATA
        sSql = "";
        sSql = " SELECT ReqAID, ReqNo," +
            " CONVERT(varchar(12), ReqDate, 101) AS TDate, EID" +
        ...
        if (dr.Read())
        {
            this.txtMRSRID.Text = Convert.ToString(dr["ReqAID"].ToString());
        ...
        sSql = "SELECT dbo.Product.ProductID, dbo.Product.Model," +
            " ABS(dbo.RequirmentDetails.ReqQty) AS Qty," +
            " dbo.RequirmentDetails.ProdRemarks as Remarks" +
            " FROM dbo.Product INNER JOIN" +
            " dbo.RequirmentDetails ON dbo.Product.ProductID = dbo.RequirmentDetails.ProductID" +
            " WHERE (dbo.RequirmentDetails.ReqAID = '" + this.txtMRSRID.Text + "')";
