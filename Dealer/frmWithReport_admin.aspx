<%@ Page Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="frmWithReport_admin.aspx.cs" Inherits="FormsReport_Admin_frmWithReport_Admin" %>
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td style="text-align: Left; font-family: Arial; " 
                    class="style40">
                    <asp:RadioButton ID="RadioButton2" runat="server" Text="Withdrawn Summary" 
                    GroupName="Sales" 
                    OnCheckedChanged="RadioButtonSales_CheckedChanged" 
                    AutoPostBack="true" />
                </td>
                ...
                <td align="center">                        
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="2"  
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NetSalesAmnt" HeaderText="Amount" HeaderStyle-Width="15%" />
                            <asp:BoundField DataField="Remarks" HeaderText="Remarks" HeaderStyle-Width="55%" />
                        </Columns>
                    ...
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Model" HeaderText="Product Model" HeaderStyle-Width="20%" />
                            <asp:BoundField DataField="ProdDesc" HeaderText="Product Description" HeaderStyle-Width="30%" />
                            <asp:BoundField DataField="SLNO" HeaderText="Product SL#" HeaderStyle-Width="20%" />
