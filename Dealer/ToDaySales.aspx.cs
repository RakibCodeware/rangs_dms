...
public partial class CTP_ToDaySales : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        sSql = "SELECT MRSRCode, CONVERT(varchar(12), TDate, 105) AS TDate," +
            ...
            " FROM dbo.Entity INNER JOIN  dbo.MRSRMaster ON dbo.Entity.EID = dbo.MRSRMaster.OutSource " +
            //" LEFT OUTER JOIN dbo.Customer ON dbo.MRSRMaster.Customer = dbo.Customer.Mobile" +
