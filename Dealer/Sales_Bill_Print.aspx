...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" style="padding:5px"> Print Dealer Bill Invoice ...</h2>

    <input id="btnPrint" type="button" value="Print" onclick="Print()" onclick="return btnPrint_onclick()" />
    &nbsp;&nbsp;&nbsp;
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="~/Dealer/sales_delivery.aspx" Font-Names="Tahoma">Back to Sales Entry</asp:HyperLink>
