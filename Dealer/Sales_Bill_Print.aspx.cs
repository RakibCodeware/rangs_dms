...
public partial class Forms_Sales_Bill_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            crv.SelectionFormula = "{VW_Sales_ChalllanWise.MRSRCode} ='" + Session["sBillNo"].ToString() + "'";
    ...
    {
        Response.Redirect("sales_delivery.aspx");
    }
