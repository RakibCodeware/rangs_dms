...
CodeFile="Withdrawn_New.aspx.cs" Inherits="Forms_Withdrawn_New" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-primary" 
        style="padding:5px; background-color: #800000; font-family: Tahoma; color: #FFFFFF;" 
        align="center"> Customer Withdrawn Entry ...</h2>
    <p>
        ...
        <table width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                ...
                <td style="text-align: Left; font-family: Arial; font-weight: 700; color: #009900;" 
                    class="style2">Withdrawn #</td>
                <td class="style3"> : </td>
                <td style="text-align: left" class="style4">
                    <asp:TextBox ID="txtCHNo" runat="server" Width="200px" 
                        CssClass="form-control" BackColor="#FFFF99"
                        style="font-weight: 700" ToolTip="Please Enter Challan Number" 
                        MaxLength="15" Enabled="False"></asp:TextBox>
                </td>
                <td class="style5">                    
                </td>
                <td class="style6" align="left">Withdrawn Date</td>
                <td class="style7">:</td>
            ...
            <tr>
                <td class="style1"></td>
                <td class="style2" align="left">Ref. Invoice #</td>
                <td class="style3">:</td>
                <td class="style4" align="left">
                    <asp:TextBox ID="txtInvoice" CssClass="form-control" 
                        runat="server" Width="200px" Height="30px">
                    </asp:TextBox>
                </td>
                <td class="style5"></td>
                <td class="style6"></td>
            ...
            <tr>
                ...
                <td style="text-align: Left; font-family: Arial; " 
                    class="style2" align="left">Unit Price</td>
                <td class="style3"> : </td>
                <td style="text-align: left" class="style4">
                                        
                    <asp:TextBox ID="txtUP" runat="server" Enabled="False"
                        CssClass="form-control" Height="30px" 
                        TabIndex="3" ToolTip="Please Enter Product Quantity"
            ...
            <tr>
                ...
                <td style="text-align: left" class="style4" align="left">
                    ...
                    <asp:TextBox ID="txtQty" runat="server" AutoPostBack="true" 
                        CssClass="form-control" Height="30px" onkeypress="return numeric_only(event)" 
                        TabIndex="3" ToolTip="Please Enter Product Quantity" Width="200px" 
                        ontextchanged="txtQty_TextChanged"></asp:TextBox>
                    
                </td>
                <td class="style5"></td>
                <td class="style6" align="left">Total Price</td>
                <td class="style7">:</td>
                <td class="style8" align="left">
                                                            
                    <asp:TextBox ID="txtTAmnt" runat="server" CssClass="form-control" 
                        Height="30px" style="font-weight: 700" TabIndex="5" 
            ...
            <tr>
                <td class="style1"></td>
                <td style="text-align: Left; font-family: Arial; " 
                    class="style2">Discount Amnt</td>
                <td class="style3"> &nbsp:&nbsp;</td>
                <td style="text-align: left" class="style4">
                    <asp:TextBox ID="txtAdjust" runat="server" AutoPostBack="true" 
                        CssClass="form-control" Height="30px" onkeypress="return numeric_only(event)" 
                        TabIndex="3" ToolTip="Please Enter Product Quantity" Width="200px" 
                        ontextchanged="txtAdjust_TextChanged"></asp:TextBox>
                </td>
                <td class="style5"></td>
                <td class="style6" align="left">Net Amount</td>
                <td class="style7">:</td>
                <td class="style8" align="left">
                    <asp:TextBox ID="txtNet" runat="server" CssClass="form-control" Enabled="False"
                        Height="30px" style="font-weight: 700" TabIndex="5" Width="200px">
                    </asp:TextBox>
                </td>
                <td class="style9"></td>
            </tr>
            ...
            <tr>
                    <td>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Unit Price" DataField="UP" />
                            <asp:BoundField HeaderText="Quantity" DataField="Qty" ItemStyle-Width="10px"/>
                            <asp:BoundField HeaderText="Total Amnt" DataField="TAmnt" />
                            <asp:BoundField HeaderText="Discount" DataField="WithAdjust" />
                            <asp:BoundField HeaderText="Net Amnt" DataField="NetAmnt" />
