...
public partial class declaration_pending : System.Web.UI.Page
{
    ...
    private void fnLoadData()
    {
        ...
        else
        {
            ...
            //{
            //    sSql = sSql + " AND (dbo.MRSRMaster.MRSRCode='" + this.txtInvNo.Text + "')";
            //}
            //if (this.txtMobile.Text.Length != 0)
            //{
            //    sSql = sSql + " AND (dbo.VW_Delear_Info.ContactNo ='" + this.txtMobile.Text + "')";
            //}
        }
    ...
    */
    ...
    protected void btnDeclar_Click(object sender, EventArgs e)
    {
        ...
        //*************************************************************************************************************
        if (Session["sStoreID"].ToString() != "370")
        {
            //AUTO DELIVERY -------------------------------------------------------
            ...
            while (dr1.Read())
            {
                ...
                gSql = "INSERT INTO MRSRDetails(MRSRMID,ProductID,Qty," +
                     ...
                     " VALUES('" + iMRSRIDdms + "','" + dr1["ProductID"].ToString() + "','" + dr1["Qty"].ToString() + "'," +
                     " '" + dr1["MRP"].ToString() + "','" + dr1["UnitPrice"].ToString() + "','" + dr1["TotalAmnt"].ToString() + "','" + dr1["DiscountAmnt"].ToString() + "'," +
                     " '" + dr1["SLNO"].ToString() + "','" + dr1["ProdRemarks"].ToString() + "','" + dr1["DisCode"].ToString() + "','" + dr1["DisRef"].ToString() + "'," +
                     " '" + dr1["WithAdjAmnt"].ToString() + "','" + dr1["RetPrice"].ToString() + "','" + dr1["NetAmnt"].ToString() + "'," +
                     " '" + dr1["BLIPAmnt"].ToString() + "','" + dr1["IncentiveAmnt"].ToString() + "','" + dr1["IncentiveType"].ToString() + "'," +
                     " '" + dr1["CustShowPrice"].ToString() + "','" + Session["sDealerMktEID"] + "','" + Session["sStoreID"] + "')";
