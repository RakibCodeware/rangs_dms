...
public partial class FormsReport_Admin_frmSalesReport_Admin : System.Web.UI.Page
{
    ...
    private void fnLoadSalesSummary_ModelWise()
    {
        ...
        sSql = "SELECT dbo.MRSRMaster.MRSRCode AS [Challan #]," +
            ...
            " AND dbo.MRSRMaster.TDate <= '" + Convert.ToDateTime(this.txtToDate.Text) + "')";
              if (ddlModel.SelectedItem.ToString() != "--Select Model--")
               {
    ...
    protected void GridView3_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            CalcTotal(e.Row.Cells[5].Text);

            double value = Convert.ToDouble(e.Row.Cells[4].Text);
            e.Row.Cells[3].Text = value.ToString("#,#.##");

            double value1 = Convert.ToDouble(e.Row.Cells[5].Text);
            e.Row.Cells[4].Text = value1.ToString("#,#.##");
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[5].Text = runningTotal.ToString("0,0", CultureInfo.InvariantCulture);
