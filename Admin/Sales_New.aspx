...
CodeFile="Sales_New.aspx.cs" Inherits="Admin_Forms_Sales_New" %>
                    ...
                    <table width="100%" style="font-family: Tahoma; font-size: small">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="ddlSalesFrom" runat="server" class="form-control" 
                                    Height="30px" Width="200px" AutoPostBack="True" 
                                    onselectedindexchanged="ddlSalesFrom_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td style="text-align: left; font-family: Arial; font-size: small; " >CTP Code</td>
                                
                            <td > : </td>
                            <td style="text-align: left; color: #FF0000;" >                                
                                <asp:TextBox ID="txtCTPCode" runat="server" Width="100px" Height="25px"
                                    ToolTip="Please Enter CTP Code" MaxLength="10" BackColor="#CCFF99" 
                                    ReadOnly="True"></asp:TextBox>                                                                                               
                            </td>

                            <td style="font-family: Arial; font-size: xx-small; color: #FF0000" ></td>                                
                        ...
                        <tr>
                                <td class="style19">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="" DataField="BLIPAmnt" ItemStyle-Width="" />
                                        <asp:BoundField HeaderText="" DataField="IncentiveAmnt" ItemStyle-Width="" />
                                        <asp:BoundField HeaderText="" DataField="IncentiveType" ItemStyle-Width="" />
                                        <asp:BoundField HeaderText="" DataField="CustShowPrice" ItemStyle-Width="" />
                    ...
                    <table width="100%" style="font-family: Tahoma; font-size: small">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                Online Order#</td> 
                            <td align="right">
                                <asp:Button ID="btnSearchByOnline" runat="server" Text="S" 
                                    onclick="btnSearchByOnline_Click" />
                            </td> 
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlSource" CssClass="form-control" runat="server" Width="200px">
                                    ...
                                    <asp:ListItem>Family Suggestion</asp:ListItem>
                                    <asp:ListItem>Brand preference</asp:ListItem>
                                    <asp:ListItem>Follow up</asp:ListItem>
                                    <asp:ListItem>Push</asp:ListItem>
                                    <asp:ListItem>Corporate Sales</asp:ListItem>
                                    <asp:ListItem>Leaflets</asp:ListItem>
                                    <asp:ListItem>Banners</asp:ListItem>
                                    <asp:ListItem>Miking</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                ...
                                <asp:Button ID="btnChk" runat="server" Text="Ok" onclick="btnChk_Click" 
                                    Visible="False" />
