...
public partial class CustomerOrder : System.Web.UI.Page
{
    ...
    protected void fnLoadOrderData()
    {
        ...
        string sSql = "";
        sSql = "SELECT DelID, DelNo, DelDate, TotalAmnt, TotalQty, DelFrom,";
        ...
        //sSql = sSql + " Where CustEmail='" + lblEmail.Text + "'";

        if (txtContact.Text.Length > 0)
        {
            sSql = sSql + " WHERE (CustName LIKE '%" + txtContact.Text + "%'";
        ...
        {
            sSql = sSql + " WHERE (CONVERT(date, DelDate1, 101)>='" + Convert.ToDateTime(this.txtFrom.Text) + "'";
    ...
    protected void fnLoadCTP()
    {
        ...
        //{
                ...
                //sqlfns = sqlfns + " AND (dbo.Entity.VirtualCTP = 0)";
