...
public partial class Search_Transfer : System.Web.UI.Page
{
    ...
    //FROM
    protected void LoadDropDownList_CTP_From()
    {
        SqlConnection conn = DBConnection.GetConnection();
        ...
        {
            conn.Open();
            ddlEntityFrom.DataSource = cmd.ExecuteReader();
            ddlEntityFrom.DataTextField = "eName";
            ddlEntityFrom.DataValueField = "EID";
            ddlEntityFrom.DataBind();

            //Add blank item at index 0.            
            ddlEntityFrom.Items.Insert(0, new ListItem("ALL", "ALL"));
    ...
    private void fnLoadData()
    {
        ...
        sSql = "SELECT dbo.MRSRMaster.MRSRMID, dbo.MRSRMaster.MRSRCode," +
            ...
            " ISNULL(dbo.MRSRMaster.NetSalesAmnt,0) AS NetSalesAmnt,  dbo.Entity.eName as TrTo," +
            " Entity_1.eName as TrFrom" +

            " FROM dbo.MRSRMaster INNER JOIN " +
            " dbo.Entity ON dbo.MRSRMaster.InSource = dbo.Entity.EID INNER JOIN " +
            " dbo.Entity AS Entity_1 ON dbo.MRSRMaster.OutSource = Entity_1.EID " +
        ...
        if (ddlEntityFrom.SelectedItem.Text != "ALL")
        {
            sSql = sSql + " AND (Entity_1.eName='" + ddlEntityFrom.SelectedItem.Text + "')";
        }
    ...
    protected void lnkDel_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        string sMasterID = grdrow.Cells[5].Text;
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        GridViewRow grdrow = (GridViewRow)((LinkButton)sender).NamingContainer;
        string rowNumber = grdrow.Cells[0].Text;
        Session["sTrCHS"] = grdrow.Cells[1].Text;
        Session["sTrMasterID"] = grdrow.Cells[5].Text;
