...
public partial class admin_product_update : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        string sSql = "";
        sSql = "SELECT dbo.Product.ProductID, dbo.Product.Model, dbo.Product.MRP, dbo.Product.UnitPrice, dbo.Product.DealerPrice,dbo.Product.DealerSpecialPrice,dbo.Product.DealerSpecialPriceExp, ";
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string sDP = (row.FindControl("txtDP") as TextBox).Text;//,dbo.Product.DealerSpecialPrice,dbo.Product.DealerSpecialPrice,
        string sSpecialDealerPrice = (row.FindControl("txtDSP") as TextBox).Text;
        string sSpecialDealerPriceExp = (row.FindControl("txtDealerOfferExp") as TextBox).Text;
        ...
        conn.Close();
        //-------------------------------------------------------------------------------------------
        //,dbo.Product.DealerSpecialPrice,dbo.Product.DealerSpecialPrice,
        gSql = "";
        gSql = "UPDATE Product SET MRP='" + mrp + "',";
        gSql = gSql + " UnitPrice='" + mrp + "',";
        gSql = gSql + " DealerPrice='" + sDP + "',";
        
        if (!string.IsNullOrEmpty(sSpecialDealerPriceExp))
        {
            gSql = gSql + " DealerSpecialPrice='" + sSpecialDealerPrice + "',";
            gSql = gSql + " DealerSpecialPriceExp='" + sSpecialDealerPriceExp + "'";
        }
        else
        {
            gSql = gSql + " DealerSpecialPrice='" + sSpecialDealerPrice + "'";
