<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_EditS.aspx.cs" Inherits="Admin_Sales_EditS" 
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent" >
    ...
    <p>
        <asp:Button ID="btnBack" CssClass="btn btn-toolbar" runat="server" Text="Back" 
                        Font-Size="Small"
                        Width="88px" TabIndex="35" onclick="btnBack_Click" /> 
                    ...
                    <table width="100%" style="font-family: Tahoma; font-size: small">
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <asp:TextBox ID="txtMRSRID" runat="server" Enabled="False" Font-Size="Smaller" 
                                    Visible="False" Width="36px"></asp:TextBox>
                                <asp:TextBox ID="txtMRSR" runat="server" Enabled="False" Font-Size="Smaller" 
                                    Visible="False" Width="36px"></asp:TextBox>
                                <asp:TextBox ID="txtEID" runat="server" Enabled="False" Font-Size="Smaller" 
                                    Visible="False" Width="36px"></asp:TextBox>
                                <asp:TextBox ID="txtDelEID" runat="server" Enabled="False" Font-Size="Smaller" 
                        ...
                        <tr>
                            ...
                            <td class="style54" align="left">                   
                                <asp:TextBox ID="txtEName" runat="server" CssClass="form-control" 
                                    MaxLength="50" placeholder="Entity Name" TabIndex="2" 
                                    ToolTip="Entity Name" Width="200px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td class="style51"></td>
                            <td class="style58">&nbsp;
                ...
                <div align="center">
                    <table width="100%" style="font-family: Tahoma; font-size: small">
                        <tr>
                            <td width="2%"></td>
                            <td width="15%">
                                 <asp:Label ID="lblMRSRDID" runat="server" Text="0" Visible="False"></asp:Label>
                                ...
                                <asp:Label ID="lblRedeemAmnt" runat="server" Text="0" Visible="False"></asp:Label>
                            </td>
                            <td width="3%">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="style60" 
                                    style="text-align: Left; font-family: Arial; font-weight: 700; color: #b22222; font-size: small;">
                                    Ref. for Discount</td>
                                <td class="style59">
                                    :
                                </td>
                                <td class="style54" style="text-align: left; width:200px;">
                                    <asp:DropDownList ID="ddlRefDiscount" runat="server" CssClass="form-control" 
                                        placeholder="Select Ref. Source" style="width: 200px;" TabIndex="5">
                                    </asp:DropDownList>
                                </td>
                                <!-- Discount Amount -->
                                <td class="style51">
                                ...
                                <td class="style58" 
                                    style="text-align: Left; font-family: Arial; color: #FF0000;">
                                    Discount Amount</td>
                                <td class="style20">
                                    :
                                </td>
                                <td class="style51" style="text-align: left">
                                    <asp:TextBox ID="txtDisAmnt" runat="server" AutoPostBack="True" 
                                        CssClass="form-control" Enabled="true" MaxLength="6" 
                                        onkeypress="fnAllowNumeric();" OnTextChanged="txtDisAmnt_TextChanged" 
                                        placeholder="Discount Amount" TabIndex="13" ToolTip="Discount Amount" 
                                        Width="200px">
                                </asp:TextBox>
                                </td>
                                <td class="style20">
                        ...
                        <tr>
                            ...
                            <td class="style51"></td>
                            <td style="text-align: Left; font-family: Arial; " 
                                class="style58">Online Order#</td>
                            <td class="style20"> : </td>
                            <td style="text-align: left" class="style51">
                                <asp:TextBox ID="txtOnlineOrder" runat="server" AutoPostBack="True" Width="200px" 
                                             CssClass="form-control"
                                             placeholder="Online Order No" TabIndex="15"></asp:TextBox>
                            </td>
                    ...
                    <table width="100%" style="font-family: Tahoma; font-size: small">
                        <tr>
                                <td class="style19">
                                    ...
                                    ShowFooter="True" OnRowCommand ="gvUsers_RowCommand"
                                    OnRowDataBound="gvUsers_RowDataBound"                        
                                    GridLines="None" Width="100%" CellPadding="4" ForeColor="#333333">
                                    <FooterStyle Font-Bold="true" BackColor="#1C5E55" ForeColor="White" />
                                    ...
                                    <Columns>                                  
                                        ...
                                        <asp:BoundField HeaderText="C.Show Price" DataField="CustShowPrice"/>
                                        <asp:BoundField HeaderText="Redeem" DataField="RedeemAmnt"/>
                                        <asp:BoundField HeaderText="C.ID" DataField="MRSRDID"/>
                                        <asp:TemplateField HeaderText="Action">
                                           <%-- <ItemTemplate>               
                                               ...
                                               <ItemTemplate>               
                                                <asp:ImageButton ID="ibtnEdit" runat="server"                                      
                                                    ImageUrl="~/Images/btn-edit.png" CommandName="Edit"   
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4">
                                ...
                                <asp:TextBox ID="txtTC" runat="server" Width="100%" 
                                    ...
                                    MaxLength="1050" Visible="true" TabIndex="32" TextMode="MultiLine" 
            ...
            <tr>
                <td align="center">                    
                    <asp:Button ID="btnSave" CssClass="btn btn-success" runat="server"  
                        ...
                        Font-Size="Small" 
                        ToolTip="Click here for Update data..." Width="130px"/>
                        &nbsp;                        
