...
public partial class search_receive : System.Web.UI.Page
{
    ...
    //LOAD CTP IN DROPDOWN LIST
    protected void LoadDropDownList_CTP_To()
    {
        SqlConnection conn = DBConnection.GetConnection();
        ...
        {
            conn.Open();
            ddlEntityTo.DataSource = cmd.ExecuteReader();
            ddlEntityTo.DataTextField = "eName";
            ddlEntityTo.DataValueField = "EID";
            ddlEntityTo.DataBind();

            //Add blank item at index 0.
            ddlEntityTo.Items.Insert(0, new ListItem("ALL", "ALL"));
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        sSql = sSql + " WHERE (dbo.MRSRMaster.TrType = 1)";
    ...
    private void fnLoadData()
    {
        ...
        if (ddlEntityTo.SelectedItem.Text != "ALL")
        {
            sSql = sSql + " AND (dbo.MRSRMaster.InSource='" + ddlEntityTo.SelectedItem.Value + "')";
        }
