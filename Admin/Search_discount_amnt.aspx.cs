...
public partial class Search_discount_amnt : System.Web.UI.Page
{
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open ('Sales_Bill_Print.aspx?val=" + Session["sBillNo"] + "','_blank');</script>");
    ...
    private void fnLoadData()
    {
        ...
        //sSql = sSql + " ISNULL(CashAmnt,0) AS CashAmnt, POCode,";
        ...
        //    sSql = sSql + " OR dbo.Customer.Mobile LIKE '%" + txtInvNo.Text + "%')";
        //}
        //else
        //{
        ...
        //-----
        sSql = "SELECT dbo.MRSRMaster.TrType, dbo.Entity.eName, dbo.MRSRMaster.MRSRCode, CONVERT(varchar(12), dbo.MRSRMaster.TDate, 105) AS TDate,";
        sSql = sSql + " dbo.Product.Model, dbo.Product.ProdName, dbo.MRSRDetails.ProductID, ";
        sSql = sSql + " dbo.MRSRDetails.UnitPrice, ABS(dbo.MRSRDetails.Qty) AS tQty, dbo.MRSRDetails.TotalAmnt,";
        sSql = sSql + " dbo.MRSRDetails.DiscountAmnt, dbo.MRSRDetails.NetAmnt, dbo.MRSRDetails.ProdRemarks, ";
        sSql = sSql + " dbo.MRSRDetails.DisCode, dbo.MRSRDetails.DisRef, dbo.MRSRDetails.WithAdjAmnt";
        ...
        sSql = sSql + " WHERE  (dbo.MRSRMaster.TrType = 3) AND (dbo.MRSRDetails.DiscountAmnt > 0)";
        if (txtInvNo.Text.Length > 0)
        {
            sSql = sSql + " AND (dbo.MRSRMaster.MRSRCode LIKE '%" + txtInvNo.Text + "%'";
            sSql = sSql + " OR dbo.MRSRMaster.POCode LIKE '%" + txtInvNo.Text + "%'";
        ...
        sSql = sSql + " ORDER BY dbo.MRSRMaster.TDate, dbo.Entity.eName, dbo.MRSRMaster.MRSRCode";
