...
CodeFile="Sales_New1.aspx.cs" Inherits="Admin_Forms_Sales_New1" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h4 class="col-sm-12 bg-primary" style="padding:5px"> Customer Sales (New Entry) ...</h4>
    <p>&nbsp;</p>
            ...
            <tr>
                <td align="center">                    
                    <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server"  Text="Save" 
                        width="88px" onclick="btnSave_Click" TabIndex="14" 
                        Font-Size="Small" 
                        ToolTip="Click here for save data..."/>
                        &nbsp;
                    <asp:Button ID="btnPrint" CssClass="btn btn-primary" runat="server" Text="Bill Print"
                        Font-Size="Small"
                        Width="88px" TabIndex="15" onclick="btnPrint_Click"/>
                        &nbsp;
