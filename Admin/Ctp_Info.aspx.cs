...
public partial class FormsReport_Admin_Ctp_Info : System.Web.UI.Page
{
    ...
    protected void fnLoadData()
    {
        ...
        sSql = "SELECT dbo.Entity.eName, dbo.Entity.EDesc, dbo.Entity.PhoneNo, dbo.Entity.ContactPerson," +
            ...
            " GROUP BY dbo.Entity.eName, dbo.Entity.EDesc, dbo.Entity.PhoneNo, dbo.Entity.ContactPerson," +
            " dbo.Entity.Desg, dbo.Entity.Status, dbo.Entity.ContactNo" +
