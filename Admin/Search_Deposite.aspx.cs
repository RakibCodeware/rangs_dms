...
public partial class Search_Deposite_info : System.Web.UI.Page
{
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        fnLoadCombo_Item(ddlPOSMachine, "BName", "ID", "tbBankList");
        ...
        string sSql = "";
        sSql = "SELECT RefAID, RefNo, DepositDate, CONVERT(VARCHAR(10), DepositDate, 103) AS DepositDate1, BankName, ";
        sSql = sSql + " BranchName, DepositAmnt, DepositType, DepositBy, Remarks, EntryDate, UserID, EID,";
        sSql = sSql + " CASE AccApproved WHEN 0 THEN 'Pending' WHEN 1 THEN 'Approved' WHEN 2 THEN 'Dishonour' END AS aStatus,";
        sSql = sSql + " AccNote, AccNoteBy, AccUpdateDate";
