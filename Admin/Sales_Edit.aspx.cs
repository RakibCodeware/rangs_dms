...
public partial class Forms_Sales_Edit : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            //this.ddlEntity.SelectedItem.Text = Convert.ToString(dr["DeliveryFrom"].ToString());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        sSql = "INSERT INTO MRSRMaster(MRSRCode,TDate,TrType," +
            ...
            " '" + this.txtCHNo.Text + "','230','" + this.txtEID.Text + "'," +
            ...
            " '" + txtDelEID.Text + "','" + this.txtNote.Text + "','" + txtRefChNo.Text + "'," +
        ...
        foreach (GridViewRow g1 in this.gvUsers.Rows)
        {
            ...
            {
                fBLIPAmnt = Convert.ToDouble(g1.Cells[13].Text);
            }
            else
            {
                fBLIPAmnt = 0;
            ...
            double dCustShowPrice = 0;
            if (g1.Cells[16].Text.Trim() != "&nbsp;")
            {
                dCustShowPrice = Convert.ToDouble(g1.Cells[16].Text);
            }
            else
            {
                dCustShowPrice = 0;
