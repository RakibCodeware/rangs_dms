<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWiseDeposit.aspx.cs" 
Inherits="DateWiseDeposit" MasterPageFile="DealerReports.master"%>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="col-sm-12 bg-danger" 
        style="padding:5px; background-color: #008080; color: #FFFFFF;"> Deposit of this Month ...
    ...
    <div>        
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            DataKeyNames="DepositDate" GridLines="Vertical" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DAmnt" HeaderText="Deposit Amount" 
